...
namespace Milestone
{
    //Inventory class with methods to control the use of the inventory by the user
    public class Inventory
    {
        ...
        public void ProductSold(Product product)
        {
            ...
            {
                if(p.showProdcutName() == product.showProdcutName())
                {
                    p.IncrementQty();
                    productInCart = true;
                }
        ...
        //method to that calls product sold or cancel This is mainly for testing in console
